...
//  Check validate Fullname
    ...
    if (regexFullname.test(fullname)) {
        document.getElementById("fullnameFail").innerHTML = "Invalid password";
...
// Check validate password 
    ...
    if (regexPassword.test(password)) {
        ...
        document.getElementById("passwordFail").innerHTML = "Password must contain Uppercase or Lowercase character or number"
