    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                data.addColumn('number', 'Total Venue');
                data.addColumn('number', 'Number of product solds');

                // Sử dụng JSTL để truy cập dữ liệu từ "trend" và đưa vào JavaScript
            <c:forEach items="${trend}" var="item">
                var name = "${item.name}";
                var total = ${item.total};
                var quantity = ${item.quantity};
                data.addRow([name, total, quantity]);
            </c:forEach>
                ...
                <div class="row">
                    <div class="col-xl-9 col-lg-9 col-sm-12 col-xs-12 shop-content-right">
                        <div class="right-product-box">
                            <center>
                                <h1 class="pt-3 pb-3 border-b"><b>TOP 3 BEST SELLER</b></h1>
                            </center>
                            ...
                            <section class="pt-10">
                                <center>
                                    <h1 class="pt-3 pb-3"><b>BILLS</b></h1>
                                </center>
                                <div style="overflow: auto;height: 300px; border: 10px;border-color: black; margin-bottom: 20px">
                                    <table class="table">
                                        <tr>
                                            <th>Bill ID</th>
                                            <th>Username</th>
                            ...
                            <section class="pt-10">
                                <center>
                                    <h1 class="pt-3 pb-3"><b>TOP 10 CUSTOMERS</b></h1>
                                </center>
                            ...
                            <section class="pt-10">  
                                <center>
                                    <h1 class="pt-3 pb-3"><b>CUSTOMER TRENDS</b></h1>
                                </center>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 shop-content-left">
                        <h2 class = "revenue">TOTAL REVENUE: $${revenue}</h2>
                    </div>
                </div>
            </div>
        </div>
